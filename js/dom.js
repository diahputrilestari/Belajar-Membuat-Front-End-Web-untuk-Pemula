...
function createBook(bookTitle, bookAuthor, bookYear, isCompleted){
    ...
    cover.setAttribute("src", "assets/book.jpg");
...
function addBook(){
    ...
    const book = createBook(bookTitle, bookAuthor, bookYear,isCompleted, false);
...
function addBookToCompleted(bookElement){
    ...
    const newBook = createBook(bookTitle, bookAuthor, bookYear,isCompleted, true);
...
function undoBookFromCompleted(bookElement){
    ...
    const bookAuthor = bookElement.querySelector(".book-desc p:nth-child(2) span").innerText;
    const bookYear = bookElement.querySelector(".book-desc p:nth-child(3) span").innerText;
    const isCompleted = bookElement.querySelector(".book-desc p:nth-child(4) span").innerText;
